    ...
    return (
      <div className='container my-5'>
        <div className='empty-cart flex justify-center align-center flex-column font-manrope'>
          ...
          <Link to = "/" className='shopping-btn bg-blue text-white fw-5'>Go shopping Now</Link>
        </div>
      </div>
    )
  }
        ...
        <div className='cart-ctable'>
              ...
              carts.map((cart, idx) => {
                return (
                  <div className='cart-ctr py-4' key = {cart?.id}>
                    ...
                    <div className='cart-ctd'>
                      <span className='cart-ctxt text-blue fw-5'>{formatPrice(cart?.totalPrice)}</span>
                    </div>
          ...
          <div className='cart-cfoot flex align-start justify-between py-3 bg-white'>
            ...
            <div className='cart-cfoot-r flex flex-column justify-end'>
              ...
              <button type = "button" className='checkout-btn bg-blue text-white bg-orange fs-16'>Check Out</button>
            </div>
          </div>
        </div>
      </div>
